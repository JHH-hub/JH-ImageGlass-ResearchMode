...
public partial class FrmMain
{
    ...
    public void IG_Delete(bool moveToRecycleBin = true)
    {
        ...
        {
            var researchDecision = Research_ShowReasonDialog("删除这张图", "delete");
            if (researchDecision == null) return;
            ...
            try
            {
                ...
                Research_EndCurrentImage("delete", moveToRecycleBin ? "delete_to_recycle_bin" : "delete_from_disk", researchDecision, deletedFromDisk: true);
